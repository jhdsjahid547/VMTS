...
@endsection
@section('head', 'Manage Teachers')
@section('body')
    <section class="pt-2">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 py-2">
                    <button class="btn btn-primary rounded-0" onclick="add()">Add Teacher</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <table id="teacherList" class="table nowrap w-100">
                        <thead>
                        <tr>
                            <th>Sl.</th>
                            <th>Name</th>
                    ...
                    <!--Create Course Modal-->
                    <div class="modal fade" id="createTeacher" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="createTeacherLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content rounded-0">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="createTeacherLabel">Add New Teacher</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="javascript:void(0)" id="teacherForm" method="post">
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-9">
                                                <input type="text" id="name" name="name" class="form-control" placeholder="Enter teacher name"/>
                                        ...
                                        <div class="row p-2">
                                            ...
                                            <div class="col-9">
                                                <input type="email" id="email" name="email" class="form-control" placeholder="Enter teacher subject"/>
...
@section('script')
    <script type="text/javascript">
        ...
        const table = $('#teacherList').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.teacher.list') }}",
            columns: [
                { data: "DT_RowIndex" },
                { data: "name" },
                { data: "email" },
        ...
        function add() {
            ...
            $("#createTeacherLabel").html("Add New Teacher");
            $("#btnSave").html("Create");
        ...
        function editFunc(id){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    selectCourse.empty();
                    let option = "";
                    $("#createTeacherLabel").html("Edit Teacher");
                    $("#btnSave").html("Update");
                    $('#createTeacher').modal("show");
                    $("#id").val(data.user.id);
        ...
        $("#teacherForm").submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('admin.teacher.submit') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: (data) => {
                    ...
                    if($.isEmptyObject(data.invalid)) {
                        resetValidation();
                        if($("#createTeacherLabel").html() === "Edit Teacher")
                        {
